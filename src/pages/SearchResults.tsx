...
import { Search, Filter, MapPin, Star, Heart, Sparkles, SlidersHorizontal, Bot, Map } from 'lucide-react';
            ...
            <div className="flex-1 max-w-2xl mx-8">
              <div className="relative">
                ...
                <Input
                  ...
                  defaultValue="Mountain cabins in Colorado"
                />
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600">Mountain cabins in Colorado</p>
          </div>
          <div className="flex items-center space-x-3">
            <Button
              variant="outline"
